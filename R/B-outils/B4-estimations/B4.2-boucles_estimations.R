source("R/B-outils/B4-estimations/B4.1-calcul_totaux.R")
lapply(list.files("R/B-outils/B3-estimateurs", pattern = "\\.R$", full.names = TRUE), source) # Importation des estimateurs
